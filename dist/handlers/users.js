    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userReq = req.body;
                return [4 /*yield*/, store.authenticateUser(userReq)];
            case 1:
                userInfo = _a.sent();
                if (userInfo) {
                    token = jsonwebtoken_1["default"].sign(userInfo, tokenSecret);
            ...
            case 2:
                err_1 = _a.sent();
                res.status(500).json({ error: "Could not authenticate user: ".concat(err_1) });
                return [3 /*break*/, 3];
