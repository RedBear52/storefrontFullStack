...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot find requested product index: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot find product ".concat(id, ": ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    ProductStore.prototype.topFiveProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Cannot find top 5 product index: ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connection.query(sql, [product.id, product.name, product.price, product.category])];
                    case 2:
                        result = _a.sent();
                        connection.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Unable to update product ".concat(product.id, ": ").concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.searchByCategory = function (category) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Unable to find products by category: ".concat(category, ": ").concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
